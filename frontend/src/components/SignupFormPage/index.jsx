...
const SignupFormPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (password.length > 5 && email.length >= 5 && isValidEmail(email)) {
      setErrors([]);
  ...
  return (
    <div className="signup-page">
      <div className="signup-header">
        <svg className="myflix-logo" width="519" height="146" viewBox="0 0 519 146" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="signup-main-center">
          <form className="signup-form" onSubmit={handleSubmit}>
            ...
            <div className="field-wrapper">
              ...
              />
              <label htmlFor="emailSignupField" className={email.length > 0 ? "placeholder-label hasText" : "placeholder-label"}>Email</label>
            </div>
            ...
            <div className="field-wrapper">
              ...
              />
              <label htmlFor="passwordSignupField" className={password.length > 0 ? "placeholder-label hasText" : "placeholder-label"}>Password</label>
            </div>
            <div className="signup-field-error">
