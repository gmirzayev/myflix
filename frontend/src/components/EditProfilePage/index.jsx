...
const EditProfilePage = ({editProfile, setShowProfile}) => {
    ...
    const handleSubmit = () => {
        if(profileName.length > 0) {
            const profile = {name: profileName, picture: "https://myflix-seeds.s3.amazonaws.com/picturesformyflix/poro.png"};
            if(newProfile) {
                setErrors([]);
                 ...
                 <div className="edit-content-wrapper">
                     ...
                     <form className="edit-profile-form">
                         <div className="edit-picture-column">
                             <img className="edit-picture" value="https://myflix-seeds.s3.amazonaws.com/picturesformyflix/poro.png" src="https://myflix-seeds.s3.amazonaws.com/picturesformyflix/poro.png"></img>
